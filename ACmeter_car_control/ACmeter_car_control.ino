...
#define IR_PIN    3 //IR receiver Signal pin connect to Arduino pin 3
 ...
 const int move_time_rot_pat_1 = 5;
 const int move_time_rot_pat_2 = 5;
 const int move_time_rot_pat_3 = 5;
 const int move_time_rot_pat_4 = 5;
 const int move_time_rot_pat_5 = 5;
 const int move_time_rot_pat_6 = 5;
 const int move_time_rot_pat_7 = 5;
 const int move_time_rot_pat_8 = 5;
 const int move_time_rot_pat_0 = 5;
